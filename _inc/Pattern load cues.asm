...
; ---------------------------------------------------------------------------
	...
	dc.w PLC_Signpost-ArtLoadCues, PLC_Signpost-ArtLoadCues
	...
	dc.w PLC_SanicSignpost-ArtLoadCues, PLC_SanicMain-ArtLoadCues
	dc.w PLC_SanicSSResult-ArtLoadCues, PLC_HongKong97-ArtLoadCues
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
PLC_SpeStage:	dc.w 0
		dc.l Nem_SanicSS	; Sanic SS main patterns
		dc.w 0
; ---------------------------------------------------------------------------
...
; Pattern load cues - act 1/2 signpost
; ---------------------------------------------------------------------------
PLC_SanicSignpost:	dc.w 2
		dc.l Nem_SignPostSanic	; signpost
		dc.w $D000
		dc.l Nem_Bonus		; hidden bonus points
		dc.w $96C0
		dc.l Nem_BigFlash	; giant	ring flash effect
...
PLC_SanicMain:	dc.w 4
		...
		dc.l Nem_Hud		; HUD
		dc.w $D940
		dc.l Nem_LivesSanic	; lives	counter
		dc.w $FA80
		dc.l Nem_Ring		; rings
		dc.w $F640
; ---------------------------------------------------------------------------
; Pattern load cues - special stage results screen
; ---------------------------------------------------------------------------
PLC_SanicSSResult:dc.w 1
		dc.l Nem_SSEmerald	; emeralds
		dc.w $A820
		dc.l Nem_MiniSanic	; mini bus
		dc.w $AA20
		even
; ---------------------------------------------------------------------------
; Pattern load cues - Hong Kong 97
; ---------------------------------------------------------------------------
PLC_HongKong97:	dc.w	9
		dc.l	ArtNem_ChinBullet
		dc.w	$F200
		dc.l	ArtNem_UglyRed3
		dc.w	$7E00
		dc.l	ArtNem_UglyRed2
		dc.w	$8400
		dc.l	ArtNem_UglyRed1
		dc.w	$8A00
		dc.l	ArtNem_EnemyBullet
		dc.w	$F240
		dc.l	ArtNem_HK97Boss
		dc.w	$9400
		dc.l	ArtNem_HK97Explosion
		dc.w	$8C00
		dc.l	ArtNem_Syringe
		dc.w	$A060
		dc.l	ArtNem_HK97Bomb
		dc.w	$A400
		dc.l	ArtNem_HK97Car
		dc.w	$D000